            ...
            <div className="grow">
              ...
              <ul className="text-sm space-y-2 mb-5 dark:text-slate-300">
                <li className="flex items-center">
                  ...
                  <div className="text-rose-500">2024年4月15日 19:00</div>
                </li>
                <li className="flex items-center">
                  <svg
                    className="w-4 h-4 fill-current text-slate-400 dark:text-slate-500 shrink-0 mr-3"
            ...
            <div className="grow">
              ...
              <ul className="text-sm space-y-2 mb-5 dark:text-slate-300">
                <li className="flex items-center">
                  ...
                  <div className="text-rose-500">2024年5月6日 14:00</div>
                </li>
                <li className="flex items-center">
                  <svg
                    className="w-4 h-4 fill-current text-slate-400 dark:text-slate-500 shrink-0 mr-3"
            ...
            <div className="grow">
              ...
              <ul className="text-sm space-y-2 mb-5 dark:text-slate-300">
                <li className="flex items-center">
                  ...
                  <div className="text-rose-500">2024年6月20日 10:00</div>
                </li>
                <li className="flex items-center">
                  <svg
                    className="w-4 h-4 fill-current text-slate-400 dark:text-slate-500 shrink-0 mr-3"
            ...
            <div className="grow">
              ...
              <ul className="text-sm space-y-2 mb-5 dark:text-slate-300">
                <li className="flex items-center">
                  ...
                  <div className="text-rose-500">2024年7月3日 09:00</div>
                </li>
                <li className="flex items-center">
                  <svg
                    className="w-4 h-4 fill-current text-slate-400 dark:text-slate-500 shrink-0 mr-3"
